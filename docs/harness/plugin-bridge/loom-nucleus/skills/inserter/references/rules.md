...
Status: accepted
Scope: inserter
Rule: Use the canonical shared name `inserter` in packages and adapter manifests; do not use `omp-`, `codex-`, or `claude-` prefixes.
...
Bad example: `omp-inserter`
Good example: `inserter`
