# Inserter package governance

This Vercel-shaped package is the canonical shared-agent source for `inserter` across OMP, Codex, Claude, and future adapters.
...
- Keep the canonical name `inserter`; harness prefixes are forbidden.
