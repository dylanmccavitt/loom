...
This Vercel-shaped package is the canonical shared-agent source for `ghosts` across OMP, Codex, Claude, and future adapters.
...
- Keep the canonical name `ghosts`; harness prefixes are forbidden.
