...
This Vercel-shaped package is the canonical shared-agent source for `bus-first` across OMP, Codex, Claude, and future adapters.
...
- Keep the canonical name `bus-first`; harness prefixes are forbidden.
