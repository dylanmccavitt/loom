...
This Vercel-shaped package is the canonical shared-agent source for `modules` across OMP, Codex, Claude, and future adapters.
...
- Keep the canonical name `modules`; harness prefixes are forbidden.
