# Science Pack package governance

This Vercel-shaped package is the canonical shared-agent source for `science-pack` across OMP, Codex, Claude, and future adapters.
...
- Keep the canonical name `science-pack`; harness prefixes are forbidden.
