...
Status: accepted
Scope: science-pack
Rule: Use the canonical shared name `science-pack` in packages and adapter manifests; do not use `omp-`, `codex-`, or `claude-` prefixes.
...
Bad example: `omp-science-pack`
Good example: `science-pack`
