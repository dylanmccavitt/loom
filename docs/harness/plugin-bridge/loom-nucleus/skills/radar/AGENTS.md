# Radar package governance

This Vercel-shaped package is the canonical shared-agent source for `radar` across OMP, Codex, Claude, and future adapters.
...
- Keep the canonical name `radar`; harness prefixes are forbidden.
