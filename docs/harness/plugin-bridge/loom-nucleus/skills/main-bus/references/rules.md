...
Status: accepted
Scope: main-bus
Rule: Use the canonical shared name `main-bus` in packages and adapter manifests; do not use `omp-`, `codex-`, or `claude-` prefixes.
...
Bad example: `omp-main-bus`
Good example: `main-bus`
