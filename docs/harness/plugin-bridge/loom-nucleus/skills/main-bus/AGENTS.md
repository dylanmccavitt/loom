...
This Vercel-shaped package is the canonical shared-agent source for `main-bus` across OMP, Codex, Claude, and future adapters.
...
- Keep the canonical name `main-bus`; harness prefixes are forbidden.
