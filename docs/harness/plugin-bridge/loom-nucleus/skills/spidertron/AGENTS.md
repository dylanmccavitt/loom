# Spidertron package governance

This Vercel-shaped package is the canonical shared-agent source for `spidertron` across OMP, Codex, Claude, and future adapters.
...
- Keep the canonical name `spidertron`; harness prefixes are forbidden.
