...
Status: accepted
Scope: spidertron
Rule: Use the canonical shared name `spidertron` in packages and adapter manifests; do not use `omp-`, `codex-`, or `claude-` prefixes.
...
Bad example: `omp-spidertron`
Good example: `spidertron`
