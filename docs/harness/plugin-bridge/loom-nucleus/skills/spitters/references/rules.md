...
Status: accepted
Scope: spitters
Rule: Use the canonical shared name `spitters` in packages and adapter manifests; do not use `omp-`, `codex-`, or `claude-` prefixes.
...
Bad example: `omp-spitters`
Good example: `spitters`
