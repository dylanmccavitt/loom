...
This Vercel-shaped package is the canonical shared-agent source for `spitters` across OMP, Codex, Claude, and future adapters.
...
- Keep the canonical name `spitters`; harness prefixes are forbidden.
