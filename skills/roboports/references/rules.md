...
Status: accepted
Scope: roboports
Rule: Use the canonical shared name `roboports` everywhere the package is referenced; do not use `omp-`, `codex-`, or `claude-` prefixes.
...
Bad example: `omp-roboports`
Good example: `roboports`
