...
Status: accepted
Scope: biters
Rule: Use the canonical shared name `biters` everywhere the package is referenced; do not use `omp-`, `codex-`, or `claude-` prefixes.
...
Exceptions: none
Source: skills/biters/references/lens-minimal-diff.md
