...
Why: Lenses replace the retired spitters, bus-first, and radar agents; keeping them selection-only preserves the shared contract's mode boundaries and small context.
