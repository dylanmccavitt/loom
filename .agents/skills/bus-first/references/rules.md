...
Status: accepted
Scope: bus-first
Rule: Use the canonical shared name `bus-first` in packages and adapter manifests; do not use `omp-`, `codex-`, or `claude-` prefixes.
...
Bad example: `omp-bus-first`
Good example: `bus-first`
